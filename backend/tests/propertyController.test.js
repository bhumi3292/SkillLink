...
process.env.MONGO_URI = 'mongodb://localhost:27017/SkillLink_test_property';
...
let workerToken, categoryId, propertyId;
...
describe('Property API', () => {
  beforeAll(async () => {
    ...
    await User.deleteMany({ email: 'worker@property.com' });
