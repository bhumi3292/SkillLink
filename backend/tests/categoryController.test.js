...
process.env.MONGO_URI = 'mongodb://localhost:27017/SkillLink_test_category';
...
describe('Category API', () => {
  beforeAll(async () => {
    ...
    await User.deleteMany({ email: 'worker@category.com' });
    // Create a worker user and get token
    const worker = await User.create({
      fullName: 'worker Category',
      email: 'worker@category.com',
