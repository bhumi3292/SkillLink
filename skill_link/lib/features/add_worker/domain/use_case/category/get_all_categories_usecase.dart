// lib/features/add_worker/domain/use_case/category/get_all_categories_usecase.dart
...
class GetAllCategoriesUsecase
  ...
  Future<Either<Failure, List<CategoryEntity>>> call() async {
    ...
    result.fold(
      (failure) =>
          print('GetAllCategoriesUsecase: Failed - ${failure.message}'),
      (categories) => print(
        'GetAllCategoriesUsecase: Success - ${categories.length} categories',
      ),
    );
    return result;
  }
