...
class _WorkerCardWidgetState extends State<WorkerCardWidget> {
  ...
  void _toggleFavorite() {
    ...
    print(
      'DEBUG: Heart icon tapped for worker: ${widget.worker.id} - ${widget.worker.title}',
    );
    ...
    if (_isFavorite) {
      ...
      _cartBloc.add(RemoveFromCartEvent(widget.worker.id!));
    } else {
      // Add to favorites
      print('DEBUG: Attempting to add to favorites');
      _cartBloc.add(AddToCartEvent(widget.worker.id!));
    }
  }
  ...
  Widget _buildImageCarousel() {
    print(
      'DEBUG: Building image carousel for worker: ${widget.worker.title}',
    );
              ...
              return ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) {
                    ...
                    final originalPath = widget.worker.images[index];
                    final alternativeUrls = [
                      '${ApiEndpoints.imageUrl}/uploads/$originalPath',
                      '${ApiEndpoints.imageUrl}/images/$originalPath',
                      '${ApiEndpoints.imageUrl}/static/$originalPath',
                    ];
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Rate: ₹${widget.worker.price.toStringAsFixed(0)}/hr',
                              style: const TextStyle(
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  (widget.worker.averageRating ?? 0.0)
                                      .toStringAsFixed(1),
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14,
